...
<body>
	...
	<div class="mainContainer fade-in">
		...
		<div class="weatherDetails">
			...
			<div class="weatherIcon">
				...
				<div class="tempValue">${temperature}°C</div>
			</div>
    ...
    if (val.includes("clouds")) {
        ...
        weatherIcon.src = "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjld66Ia5g_hpBn3Impi3zzOBHqWkjQInGLxTb2uXksuCsrkQU8HjlVyLobEJEGg8fRSIxeFzldGEHUmWcaiZBwAcRy4dGDpFX1BjTSB56qmBjW5tEW3RSC9_mCuLU_a8RuXchxGY7Oc8HLLl-IfaDW19Z0ZJJfNae9tECXRIyEu7rmJ3da08z8cI-phw/s320/haze.png";
    	 ...
    	 weatherIcon.src = "https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Weather_icon_-_unknown.svg/2048px-Weather_icon_-_unknown.svg.png";
    }
    ...
    function updateTime() {
      ...
      document.getElementById("live-date").innerText = now.toLocaleString('en-IN', options);
    }
    updateTime();
    setInterval(updateTime, 1000);

    // Dark mode toggle
    const toggleModeBtn = document.getElementById("darkModeToggle");
    toggleModeBtn.addEventListener("click", () => {
      document.body.classList.toggle("dark-mode");
      toggleModeBtn.innerText = document.body.classList.contains("dark-mode") ? "☀️ Light Mode" : "🌙 Dark Mode";
    });
  </script>
</body>
</html>
